    ...
    <form action="{{ url('/home') }}" method="post">
        ...
        <div class="flex justify-left">
            <div class="ml-9  ml-40">
                ...
                <input type="submit" value="search" class="bg-white px-10 hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow">
