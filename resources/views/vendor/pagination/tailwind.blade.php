...
<nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between">
    ...
    <div class="hidden sm:flex-1 sm:flex sm:items-start sm:justify-center lg:items-center lg:justify-between">
        <div>
        ...
        <div>
            <span class="relative z-0 inline-flex rtl:flex-row-reverse shadow-sm rounded-md absolute  lg:bottom-0 lg:right-36 p-2">
                {{-- Previous Page Link --}}
                @if ($paginator->onFirstPage())
